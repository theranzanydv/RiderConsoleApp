...
{
    public static void EmployeeDetails(string name, string address, int number)
    {
        List<EmployeeModel> list = new List<EmployeeModel>
        {
            new EmployeeModel { Name = "Apple", Address = "Kathmandu", Number = 123, IsTemp = true },
            new EmployeeModel { Name = "Ball", Address = "Kathmandu", Number = 123, IsTemp = true },
        ...
        List<EmployeeModel> sortedList = list.OrderBy(z => z.CreatedAt).ToList();
